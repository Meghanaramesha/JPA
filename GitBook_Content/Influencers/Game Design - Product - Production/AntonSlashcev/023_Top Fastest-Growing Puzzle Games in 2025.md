...
Here are some of the puzzle games with the biggest revenue growth this year:  
...
𝗞𝗲𝘆 𝘁𝗮𝗸𝗲𝗮𝘄𝗮𝘆𝘀:  
→ China and Turkey are the real POWERHOUSES behind puzzle game growth  
→ Merge and Match mechanics continue to drive huge revenue.  
→ Microfun is a powerhouse with three major hits (Gossip Harbor, Seaside Escape, Flambé).  
→ Hyper-casual publishers are successfully moving into the space.
