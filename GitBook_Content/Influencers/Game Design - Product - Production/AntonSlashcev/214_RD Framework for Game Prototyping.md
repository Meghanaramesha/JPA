...
Below is the framework we often use when starting work on new projects:  
...
DISCLAIMER: This framework is NOT a “one-size-fits-all” solution for all genres and business models, nor is it the only possible one. However, it is effective for small and medium teams without a huge budget who are working on new casual, hybrid-casual, or indie games.
