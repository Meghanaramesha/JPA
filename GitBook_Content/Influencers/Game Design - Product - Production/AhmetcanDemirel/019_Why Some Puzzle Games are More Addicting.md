# Why Some Puzzle Games are More Addicting?
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/77c78214-9238-4c6a-b0da-6f3abb9ab4be/image22.png)

“Pair” games mainly consisting of Physical Match and Tile Match titles didn’t take long to become the third largest puzzle subgenre.
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/73115884-db01-494e-80a9-78eb24172224/Screenshot+2025-02-03+at+13.04.54.png)

5 different hybridcasual puzzles (*Screw Jam*, *Hexa Sort*, *Seat Away*, *Twisted Tangle*, and *Block Jam 3D*) with 5 different core mechanics.
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/6762ef12-cc8c-4a61-86c6-50c1eae305a0/Screenshot+2025-02-03+at+13.06.16.png)

A healthy mixture of IAP and rewarded ad offers is common across all hybridcasual puzzles.
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/908204d6-34fd-45e2-8d51-6b44dad8c72b/Screenshot+2025-02-03+at+13.06.43.png)

*Screw Jam* (left), *Block Jam 3D* (middle), and *Hexa Sort* (right) using the end game rewarded ad offer.
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/59b43180-0df1-4cf9-a386-2fb8f325b731/image16.png)

[Florian Steinhoff’s GDC talk from 10 years ago](https://www.youtube.com/watch?v=QctcE3-xTBI) still holds true for today’s best casual puzzles.
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/10597b5f-9913-491d-8483-f03f8cac92f6/Screenshot+2025-02-03+at+13.08.14.png)

*Screw Jam* (left), *Hexa Sort* (middle), and *Seat Away* (right) with their various live events and offers available on the main screen.

Some of the most successful hybridcasual puzzles even go a step further by integrating motivators like win streaks, a popular feature in the casual space which we talked about in detail in a [previous article](https://www.gamigion.com/win-streak-gift-that-keeps-on-giving/). These win streak mechanics reward players for consecutive victories, pushing them to keep playing in order to maintain their streak. This not only increases player retention but also offers a more meaningful gameplay experience for more loyal and invested players.
...
We talked about Tile Match, another emerging casual puzzle subgenre, in a [previous article](https://www.gamigion.com/tile-match-the-new-match-3-or-the-new-merge/) mentioning its potential and the design challenges that needed to be solved. Over a year later, we haven’t seen the subgenre explode in popularity, despite a few successful examples on the market. The main reason for this slow growth lies in the deterministic nature of Tile Match games. Their level design leaves little room for unpredictability, making gameplay feel somewhat rigid. This lack of randomness limits the thrill puzzle players often seek: **the excitement of sudden shifts or unexpected changes within a level**.
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/8b88bf8c-722e-4131-92b8-69c949383164/Screenshot+2025-02-03+at+13.12.00.png)

*Block Jam 3D* (left) and *Hexa Sort* (right) adding randomness to their gameplay.
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/dcc2bfc8-2682-477a-a43e-163e6af8f23a/Screenshot+2025-02-03+at+13.22.32.png)

You need to continue playing to discover what item comes next in *Seat Away*.
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/957966f8-9c32-4737-8400-c87c7a6cf832/Screenshot+2025-02-03+at+13.29.01.png)

Instead of stacking items on top of each other like *Tile Busters* (right), *Screw Jam* (left) uses translucent glasses between layers that makes things feel less deterministic.
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/49cdea3a-4a6a-410d-8899-6d9e4685b568/Seat+Away.gif)

Dragging several items around without a single change on the board can sometimes be frustrating…
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/a16bc1dd-eddb-468a-881b-5e93c5ab0e0c/Churn.gif)

To encourage spending without causing excessive churn, allow players to progress after a few attempts at the same level. Special thanks to [Yasin Hatiboğlu](https://www.linkedin.com/in/tyhat/) for the great data visualization.
