...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/cb31e261-c090-4abd-94c4-6d076f421157/image11.png)

*Top Merge games over the last 52 weeks, iOS & Android, Worldwide.*
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/3b65f02b-6253-473c-8d90-bb590ed08506/image1.png)

*Top Match-3 games over the last 52 weeks, iOS & Android, Worldwide.*
...
What is and is not a Tile Match?
--------------------------------

Tile Match is a pretty intuitive name. Each level consists of tiles stacked on top of each other. There is a “rack” for players to collect and match those tiles. Once they collect 3 of the same kind there, the items match and are removed. Players are limited to a certain amount of tiles (usually 7) inside that rack before making a match while clearing out the whole board to beat a level. Games like [Zen Match](https://apps.apple.com/de/app/zen-match-relaxing-puzzle/id1560124228), [Triple Tile](https://apps.apple.com/us/app/triple-tile-match-puzzle-game/id1572661625), and [Tile Busters](https://apps.apple.com/de/app/tile-busters/id6443449716) all belong to this category.

![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/5550b519-3e2a-4fad-b231-dfec5e89aab1/image2.png)

*A screenshot from Tile Busters displaying a typical Tile Match level.*

Although we are using the term Tile Match for this genre, data.ai prefers “Connect Tiles” which actually covers several other types of mechanics. Games like [Cube Master 3D](https://apps.apple.com/us/app/cube-master-3d-classic-match/id1578906034), [Goods Match 3D](https://apps.apple.com/us/app/goods-match-3d-triple-master/id1619057157), and [Onet Puzzle](https://play.google.com/store/apps/details?id=onet.tile.match.puzzle.android&hl=en&gl=US) are also put into this category and differ greatly from the mechanics we described as Tile Match. Each mechanic still remains too small to have a namesake genre. The games that fall under the “Tile-Matching” category in data.ai, on the other hand, are not really what we mean by Tile-Matching here.

However, there is another type of mechanic that is quite similar to Tile Match yet should be treated as a separate genre. Games like [Match 3D](https://apps.apple.com/us/app/match-3d/id1502447854) or [Triple Match 3D](https://apps.apple.com/us/app/triple-match-3d/id1607122287) belong to this group. This genre can be called “Physical Match” due to its very physics-based gameplay. There is no structured layout for the levels or a casual puzzle-like level design. Players are given a group of items that have different behaviors depending on their shapes. The objective is to either match a specified number of particular items or clear the entire board. Its popularity is widespread enough that it can be found in many puzzle ads as well as in Tactile’s Makeover Match game.

![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/62573ccf-55f3-4b0e-8921-6da915ff6341/Screenshot+2023-09-30+123628.png)

*Match 3D (left) wants you to match everything and Triple Match 3D (right) wants you to match the level items.*
...
The Short History of Tile Match
-------------------------------
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/bf6347d6-07f0-4289-90e2-4eecf2fa98b6/Screenshot+2023-09-30+123743.png)

*A screenshot from Mahjong Club showing a typical level for a Mahjong Solitaire game.*
...
* Using square tiles simplifies level design by allowing for more items to be included, as each item takes up less space
* Using universal symbols simplifies the gameplay for players, as it makes recognizing and matching items easier
...
* Making matches of two results in faster gameplay for Mahjong Solitaire, but it lacks the depth of puzzle-solving compared to Tile Match
* Having a space to collect items before matching them provides players with more room for planning and strategy
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/d7e7f515-eb57-4c1e-b32d-7695d1361890/image6.png)

*Top Mahjong Solitaire games over the last 52 weeks, iOS & Android, Worldwide.*

![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/7a8e3cba-fc68-4bae-b26c-4ab91ccf4dc4/image9.png)

*Top Tile Match games over the last 52 weeks, iOS & Android, Worldwide.*
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/6b8066a4-eb9a-46cf-93cc-ae7b63919170/image4.png)

*Most downloaded Tile Match games over the last 52 weeks, iOS & Android, Worldwide.*
...
1. **Layer 1:** Tiles at the top that can be collected
2. **Layer 2:** Tiles beneath that are not entirely covered with a portion of their symbol visible
3. **Layer 3**: Tiles that are completely concealed and can only be uncovered by collecting the tile positioned above them.

Players of a Tile Match game can look at the first and the second type of tiles at a given moment to devise a plan.

![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/1ba5aa15-ca47-47ec-bb82-66b9652b1e11/image10.png)

*Look at the tiles as long as you’d like, you have to reveal the hidden ones at some point to beat the level.*
...
The unstoppable rise of Tile Match
----------------------------------
...
![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/3843ec26-b5db-4792-b431-85f8f3811cc4/image7.png)

*Download trend for the most downloaded Tile Match games since the beginning of 2023.*

![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/7fb34749-9cf7-49f3-aa3b-7ce6fb64757b/image5.png)

*Revenue trend for the top Tile Match games since the beginning of 2023.*
