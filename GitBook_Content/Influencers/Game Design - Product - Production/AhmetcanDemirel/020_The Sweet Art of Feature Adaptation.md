...
*Royal Match* (left) and *Toon Blast* (right) explain how Super Light Ball works.
...
**Adapting, Not Copying: Making Features Your Own**
---------------------------------------------------
...
*Candy Crush Saga*with arguably the best Super Light Ball design so far…
...
Another example of this customized approach is seen in *Merge Mansion* with their handling of the Supercharge feature. Supercharge acts as an accelerator in Merge games, doubling the energy consumption of item generators in exchange for producing higher-level items. For a long period, *Merge Mansion* didn’t include this feature at all while it has been utilized by games like *Gossip Harbo*r and *Travel Town*. For more information on how Merge Games adapted this feature from social casino games, you can check out [Jesper Gustavsson’s great deconstruction of *Gossip Harbor*](https://www.deconstructoroffun.com/blog/2024/8/19/finding-genre-success-the-case-of-gossip-harbor).

![](https://images.squarespace-cdn.com/content/v1/58af450eb3db2b0582612f1d/2ff5b59f-cfc5-441e-a4b1-c8107e79d405/3.png)

*Gossip Harbor*(left) lets players double the stakes permanently while *Merge Mansion*(right) using it as an event.
...
**Pilot Testing Through Other Games**
-------------------------------------
...
*Matchington Mansion* (top) and *Project Makeover* (bottom), offer the same feature with slightly different requirements.
...
*Homescapes* (top) and Fishdom (bottom) already received their updates, likely providing data for *Gardenscapes* to follow them.
