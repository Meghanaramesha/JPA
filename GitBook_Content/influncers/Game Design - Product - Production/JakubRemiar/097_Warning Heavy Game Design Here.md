...
![](https://www.gamigion.com/wp-content/uploads/2025/02/image-79.png)
...
A good example of this would be Social Casino games, such as [Scopely](https://www.linkedin.com/company/scopely/)‘s Monopoly GO 🎰, where big amounts of energy can be swiftly spent by multiplying your energy output by 100x together with your rewards also being 100x. Another example is [Habby](https://www.linkedin.com/company/habbyfun/)‘s Capybara GO 🐊, where there is the Adventure mechanic, which is not automating the main core loop as in Monopoly GO, but it enables the user to quickly extend their idle rewards gain by using all of their energy if they don’t have time for a normal session.  
